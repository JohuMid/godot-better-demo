...
@export var json_path: String = "res://resources/item/cup/spritesheet.json"
@export var type: String = "End_Idle"
var original_frame_width: int = 64
var original_frame_height: int = 64
